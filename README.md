<img src="https://github.com/user-attachments/assets/67af1495-4a3d-4dca-ae60-e592e8c67cfa" height=150 width=150>
...
## 프로젝트 소개
### 공강시간이 두려운 당신...! 오늘의 질문지를 받고 깊게 생각하는 시간을 가져보기!
### 그리고 그 답변들을 모아서 모아서 간직하고 되새겨보자!
<br>

- **기능 1**: 오늘의 질문을 받고 답변할 수 있는 기능
- **기능 2**: 오늘의 질문들을 모아서 나의 기록으로 저장하고 보관하는 기능
- **기능 3**: 힐링과 관련한 영화, 교내 명상공간, 사색과 관련한 강의 추천 서비스 (구현예정)
  <br>
